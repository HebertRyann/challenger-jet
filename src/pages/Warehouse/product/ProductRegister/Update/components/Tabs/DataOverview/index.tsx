...
export const DataOverview = ({
  ...
  useEffect(() => {
    const childrens = categoryFinances.filter(
      parents => parents.parent_id == overview.getData().categoryCost.value.id
    )
      ...
      <div className="row">
        <div className="form-content col-md-3">
          ...
          <NewSelect
            ...
            isSelected={
              overview.getData().typeSelectProdut.value.name === 'consumo'
                ? 'uso e consumo'
                : overview.getData().typeSelectProdut.value.name
            }
            onChange={event => {
        ...
        <div className="form-content col-md-3">
          ...
          <NewSelect
            ...
            isSelected={overview.getData().groupProduct.value.name}
            onChange={event => {
              const split = event.target.value.split('+')
              const id = split[0]
              const name = split[1]
        ...
        <Container className="form-content col-md-3">
          ...
          <NewSelect
            ...
            isSelected={overview.getData().categoryCost.value.name}
            onChange={event => {
              const split = event.target.value.split('+')
              const id = split[0]
              const name = split[1]
        ...
        <Container className="form-content col-md-3">
          ...
          <NewSelect
            ...
            isSelected={overview.getData().subCategoryCost.value.name}
        ...
        <Container className="form-content col-md-3">
          ...
          <NewSelect
            ...
            isSelected={overview.getData().hasVariation.value.name}
          >
